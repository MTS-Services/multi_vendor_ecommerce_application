...
class ProductTagController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return DataTables::eloquent($query)
                ...
                ->editColumn('deleted_by', function ($product_tag) {
                    return $product_tag->deleter_name;
                })
                ->editColumn('deleted_at', function ($product_tag) {
                    return $product_tag->deleted_at_formatted;
                })
                ->editColumn('action', function ($product_tag) {
    ...
    protected function trashedMenuItems($model): array
    {
        return [
            ...
            [
                ...
                'p-delete' => true,
                'permissions' => ['product-tags-permanent-delete']
            ]
    ...
    {
        $productTag = ProductTag::findOrFail(decrypt($id));
        $productTag->update(['deleted_by' => admin()->id]);
        $productTag->delete();
    ...
    public function restore(string $id): RedirectResponse
    {
        ...
        $product_tag->restore();
        session()->flash('success', 'product_tag restored successfully!');
