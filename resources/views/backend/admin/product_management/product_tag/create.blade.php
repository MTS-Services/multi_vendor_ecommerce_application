            ...
            <div class="card-body">
                <form action="{{ route('pm.product-tags.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>{{ __('Sort Order') }} <span class="text-danger">*</span></label>
                        <input type="text" value="{{ old('sort_order') }}" id="title" name="sort_order" class="form-control"
                            placeholder="Enter Sort Order">
                        <x-feed-back-alert :datas="['errors' => $errors, 'field' => 'sort_order']" />
                    </div>
                    {{-- Name --}}
                    <div class="form-group">
