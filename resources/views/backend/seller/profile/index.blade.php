                        ...
                        <form action="{{ route('seller.profile.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" name="username" class="form-control" value="{{ old('username', $seller->username) }}">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select name="is_verify" class="form-control">
                                        <option value="1" {{ old('is_verify', $seller->is_verify) == 1 ? 'selected' : '' }}>Verified</option>
                                        <option value="0" {{ old('is_verify', $seller->is_verify) == 0 ? 'selected' : '' }}>Not Verified</option>
                                    </select>
                                    @error('is_verify') <small class="text-danger">{{ $message }}</small> @enderror
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select name="gender" class="form-control">
                                        ...
                                        <option value="others" {{ old('gender', $seller->gender) === 'others' ? 'selected' : '' }}>Others</option>
                                    </select>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="date" name="email_verified_at" class="form-control" value="{{ old('email_verified_at', $seller->email_verified_at ? $seller->email_verified_at->format('Y-m-d') : '') }}">
                                    @error('email_verified_at') <small class="text-danger">{{ $message }}</small> @enderror
                                </div>

                                <div class="col-md-12 mb-3">
                                    <label>{{__('OTP Sent At')}}</label>
                                    <input type="datetime-local" name="otp_send_at" class="form-control" value="{{ old('otp_send_at', $seller->otp_send_at ? $seller->otp_send_at->format('Y-m-d\TH:i') : '') }}">
                                    @error('otp_send_at') <small class="text-danger">{{ $message }}</small> @enderror
                                </div>

                                <div class="col-md-12 mb-3">
                                    <label>{{__('Emergency Phone')}}</label>
                                    <input type="text" name="emergency_phone" class="form-control" value="{{ old('emergency_phone', $seller->emergency_phone) }}">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" name="father_name" class="form-control" value="{{ old('father_name', $seller->father_name) }}">
                                    @error('father_name') <small class="text-danger">{{ $message }}</small> @enderror
                                </div>

                                <div class="col-md-12 mb-3">
                                    <label>{{__("Mother's Name")}}</label>
                                    <input type="text" name="mother_name" class="form-control" value="{{ old('mother_name', $seller->mother_name) }}">
