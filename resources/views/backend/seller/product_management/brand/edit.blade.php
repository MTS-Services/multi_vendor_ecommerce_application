        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <x-backend.admin.button :datas="[
                        'routeName' => 'seller.pm.brand.index',
                        'label' => 'Back',
                    ]" />
            </div>
            <div class="card-body">
                <form action="{{ route('seller.pm.brand.update', encrypt($brand->id)) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
...
<script>
        $(document).ready(function() {
            ...
            file_upload(["#logo"], "uploadImage", "seller", existingFiles, false);
        });
    </script>
{{-- FilePond  --}}
@endpush
