...
@section('content')
    <div class="bg-bg-lightSecondary dark:bg-bg-darkQuaternary pb-10">
        <div class="container">
            ...
            <div class="flex flex-col lg:flex-row gap-8 mt-5">
                {{-- Cart Items Section --}}
                <div class="lg:w-2/3 bg-bg-white dark:bg-bg-darkTertiary p-10 pt-15 rounded-md">
                    {{-- Cart Table --}}
                    ...
                    <div class="mt-6 flex">
                        <input type="text" placeholder="Discount code"
                            class="border border-border-light dark:border-opacity-50 focus:outline-primary focus:opacity-50 rounded p-2 text-sm w-full h-12 max-w-xs">
                    ...
                    <div class="mt-6">
                        ...
                        <textarea
                            class="border border-border-light resize-none bg-transparent dark:border-opacity-50 rounded-md focus:outline-primary focus:opacity-50 w-full p-2 h-24 text-sm"></textarea>
                    </div>
                ...
                <div class="lg:w-1/3">
                    ...
                    <div
                        ...
                        <div class="swiper testimonial">
                            ...
                            <!-- Navigation buttons -->
                            <div class="swiper-button swiper-button-prev left-0 top-[210px] !bg-bg-white opacity-100">
                                <i data-lucide="chevron-left" class="!w-8 !h-8 text-text-black rounded-full"></i>
                            </div>

                            <div class="swiper-button swiper-button-next left-15 top-[210px] !bg-bg-white opacity-100">
                                <i data-lucide="chevron-right" class="!w-8 !h-8 text-text-black rounded-full"></i>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="bg-bg-gray dark:bg-bg-darkSecondary py-8 md:py-18">
        <div class="container">
            ...
            <div class="swiper cart-product mt-10">
                ...
                <!-- Navigation buttons -->
                <div class="swiper-button swiper-button-prev bg-bg-accent shadow-xl w-8 h-8 rounded-full font-bold">
                    <i data-lucide="chevron-left" class="w-5 h-5"></i>
                </div>

                <div class="swiper-button swiper-button-next bg-bg-accent shadow-xl w-8 h-8 rounded-full font-bold">
            ...
            cartItems.forEach(item => {
                ...
                <div class="w-[75%] flex flex-col">
                    ...
                    <div class="flex gap-2 items-center my-2">
                        <span class="text-sm text-text-danger font-medium">$${item.price.toFixed(2)}</span>
                        <span class="text-sm font-medium line-through text-text-gray">$${(item.price * item.quantity).toFixed(2)}</span>
                    </div>
                    <div
                        class="flex items-center shadow-sm rounded-full w-24 p-[2px] bg-bg-accent bg-opacity-60 dark:bg-opacity-50 text-text-white">
                        <button class=" px-2 py-1 decrease-quantity" data-id="${item.id}">-</button>
                        <input type="text" value="${item.quantity}" class="p-0 w-8 h-4 text-center border-x bg-transparent"
                            readonly>
                        <button class="px-2 py-1 increase-quantity" data-id="${item.id}">+</button>
                    </div>
                </div>
