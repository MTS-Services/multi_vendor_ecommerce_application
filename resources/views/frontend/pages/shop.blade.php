...
@section('content')
    ...
    <div class="container">
        <div class="flex gap-5">
            {{-- Sidebar Start Here --}}
            <div
                class="filter-sidebar w-100 xl:w-[25%] hidden xl:block dark:bg-bg-darkSecondary p-4 rounded-md dark:bg-opacity-30">
                    ...
                    <div class="collapse-content text-sm">
                        <fieldset class="flex flex-wrap gap-2">
                            <label class="cursor-pointer">
                                ...
                                <div
                                    class="px-4 py-2 rounded-lg border shadow-md border-border-dark border-opacity-20 peer-checked:border-border-accent peer-checked:bg-bg-accent peer-checked:text-white transition-all duration-300">
                                    XS (10)
                                </div>
                            </label>
            ...
            <div class="w-full xl:w-[75%]">
                <div class="flex items-center justify-between">
                    <div class="w-full flex items-center gap-3">
                        <button
                            class="openFilterSidebar btn rounded-full bg-bg-transparent border border-bg-accent text-text-accent xl:hidden">
                            <span><i data-lucide="sliders-horizontal" class="w-5 h-5"></i></span>
                            <span class="ml-2 text-base">Filter</span>
                        </button>
                        <details class="dropdown">
                            <summary
                                class="btn rounded-full bg-bg-transparent dark:bg-bg-darkSecondary border border-bg-accent text-text-accent dark:text-text-white text-base min-w-[200px]">
                ...
                <div id="productGrid" class="grid grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-5 gap-y-10 mt-5">
